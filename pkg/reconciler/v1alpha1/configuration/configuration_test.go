...
func RevisionFromConfig(key string) ObjectTransform {
	return ObjectTransform{
		Key: key,
		Transform: func(o metav1.Object) metav1.Object {
			return resources.MakeRevision(o.(*v1alpha1.Configuration))
		},
	}
}
...
func TestReconcile(t *testing.T) {
	table := TableTest2{{
		...
		WantCreates: []Create{
			RevisionFromConfig("no-revisions-yet"),
		},
		WantUpdates: []Update{
			ObjectChange{
				Key: "no-revisions-yet",
				Updates: []ObjectUpdate{
					{"Status.LatestCreatedRevisionName", "no-revisions-yet-01234"},
					{"Status.ObservedGeneration", "1234"},
