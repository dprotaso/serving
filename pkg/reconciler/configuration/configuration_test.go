...
import (
	...
	// TODO(dprotaso) drop when we don't need serving external API versions in reconciler.Base
	...
	. "knative.dev/serving/pkg/reconciler/testing/internalversion"
	. "knative.dev/serving/pkg/testing/internalversion"
)
