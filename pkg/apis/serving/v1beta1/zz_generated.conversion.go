...
func autoConvert_v1beta1_ConfigurationSpec_To_serving_ConfigurationSpec(in *ConfigurationSpec, out *serving.ConfigurationSpec, s conversion.Scope) error {
	// WARNING: in.Template requires manual conversion: inconvertible types (knative.dev/serving/pkg/apis/serving/v1beta1.RevisionTemplateSpec vs *knative.dev/serving/pkg/apis/serving.RevisionTemplateSpec)
	return nil
}
...
func autoConvert_serving_ConfigurationSpec_To_v1beta1_ConfigurationSpec(in *serving.ConfigurationSpec, out *ConfigurationSpec, s conversion.Scope) error {
	...
	// WARNING: in.Template requires manual conversion: inconvertible types (*knative.dev/serving/pkg/apis/serving.RevisionTemplateSpec vs knative.dev/serving/pkg/apis/serving/v1beta1.RevisionTemplateSpec)
	return nil
}
