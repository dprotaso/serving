...
${CODEGEN_PKG}/generate-internal-groups.sh "deepcopy,conversion,client,informer,lister" \
  knative.dev/serving/pkg/client/serving \
  knative.dev/serving/pkg/apis knative.dev/serving/pkg/apis \
...
# TODO(dprotaso) update injection to work with internal types and generation
#                injection for serving API types
